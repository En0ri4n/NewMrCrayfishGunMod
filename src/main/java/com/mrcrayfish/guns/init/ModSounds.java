...
public class ModSounds
{
	...
	public static SimpleSoundInstance forSource(SoundEvent soundEvent, SoundSource soundSource, float volume, float pitch, double x, double y, double z)
	{
		return new SimpleSoundInstance(soundEvent.getLocation(), soundSource, pitch, volume, false, 0, SoundInstance.Attenuation.NONE, x, y, z, true);
	}
