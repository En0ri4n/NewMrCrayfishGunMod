...
{
    private static final ResourceLocation HOLO_RETICLE = Reference.getLoc("textures/effect/holo_reticle.png");
    private static final ResourceLocation HOLO_RETICLE_GLOW = Reference.getLoc("textures/effect/holo_reticle_glow.png");
